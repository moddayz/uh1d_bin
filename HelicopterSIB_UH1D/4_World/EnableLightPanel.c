class ActionEnableLightPanelHeliCB_UH1D : ActionContinuousBaseCB
{
...
class ActionHeliEnableLightPanelSIB_UH1D: ActionContinuousBase
{
	void ActionHeliEnableLightPanelSIB_UH1D()
	{
		m_CallbackClass = ActionEnableLightPanelHeliCB_UH1D;
