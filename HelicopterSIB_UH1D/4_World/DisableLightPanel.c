class ActionDisableLightPanelHeliCB_UH1D : ActionContinuousBaseCB
{
...
class ActionHeliDisableLightPanelSIB_UH1D: ActionContinuousBase
{
	void ActionHeliDisableLightPanelSIB_UH1D()
	{
		m_CallbackClass = ActionDisableLightPanelHeliCB_UH1D;
