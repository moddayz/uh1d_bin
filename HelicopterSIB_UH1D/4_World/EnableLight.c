class ActionEnableLightHeliCB_UH1D : ActionContinuousBaseCB
{
...
class ActionHeliEnableLightSIB_UH1D: ActionContinuousBase
{
	void ActionHeliEnableLightSIB_UH1D()
	{
		m_CallbackClass = ActionEnableLightHeliCB_UH1D;
