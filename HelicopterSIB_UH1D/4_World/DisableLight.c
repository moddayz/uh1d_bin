class ActionDisableLightHeliCB_UH1D : ActionContinuousBaseCB
{
...
class ActionHeliDisableLightSIB_UH1D: ActionContinuousBase
{
	void ActionHeliDisableLightSIB_UH1D()
	{
		m_CallbackClass = ActionDisableLightHeliCB_UH1D;
