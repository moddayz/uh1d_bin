...
modded class MissionServer
{
	...
	{
		if(child_name.Contains("HeliSIB_UH1D") ||child_name.Contains("HeliSIB_UH1D_airforce") ||child_name.Contains("HeliSIB_UH1D_iron") ||child_name.Contains("HeliSIB_UH1D_navy") )
		{
